...
@section('title')
    Laporan Penjualan Tunai {{ tanggal_indonesia($tanggalAwal, false) }} s/d {{ tanggal_indonesia($tanggalAkhir, false) }}
@endsection
...
@includeIf('laporan.penjualan.tunaiform')
@endsection
...
<script>
    ...
    $(function () {
        table = $('.table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route("penjualantunai.data", [$tanggalAwal, $tanggalAkhir]) }}',
            },
            columns: [
