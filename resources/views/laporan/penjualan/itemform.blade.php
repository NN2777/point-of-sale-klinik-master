<div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="modal-form">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('laporan-penjualan-item.index') }}" method="get" data-toggle="validator" class="form-horizontal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="item" class="col-lg-2 col-lg-offset-1 control-label">Item</label>
                        <div class="col-lg-6">
                            <input type="text" name="item" id="item" class="form-control" required value="{{ request('item') ?? '' }}">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
